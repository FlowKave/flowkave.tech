...
assert(core.includes("manager: ['dashboard', 'customerBank', 'aiAssistant', 'menu', 'sales', 'recipes', 'inventory', 'accounting', 'personnel', 'account', 'staff:manage']"), 'Manager role must retain full operational permissions.');
