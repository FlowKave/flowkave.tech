...
mustContain(html, 'styles.css?v=qr-receipt-persistent-114');
mustContain(html, 'core.js?v=qr-receipt-persistent-114');
mustContain(html, 'app.js?v=qr-receipt-persistent-114');
mustContain(html, 'core.js?v=qr-receipt-persistent-114');
...
mustContain(dashboardSource, 'qr-receipt-persistent-114', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=qr-receipt-persistent-114') && index.includes('core.js?v=qr-receipt-persistent-114') && index.includes('app.js?v=qr-receipt-persistent-114'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
