...
mustContain(html, 'styles.css?v=staff-list-print-table-56');
mustContain(html, 'core.js?v=staff-list-print-table-56');
mustContain(html, 'app.js?v=staff-list-print-table-56');
mustContain(html, 'core.js?v=staff-list-print-table-56');
...
mustContain(dashboardSource, 'staff-list-print-table-56', 'Dashboard iframe cache-bust token must match the online staff login asset.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=staff-list-print-table-56') && index.includes('core.js?v=staff-list-print-table-56') && index.includes('app.js?v=staff-list-print-table-56'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
