...
mustContain(html, 'styles.css?v=email-optional-inline-27');
mustContain(html, 'core.js?v=email-optional-inline-27');
mustContain(html, 'app.js?v=email-optional-inline-27');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=email-optional-inline-27') && index.includes('core.js?v=email-optional-inline-27') && index.includes('app.js?v=email-optional-inline-27'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
