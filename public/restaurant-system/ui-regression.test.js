...
mustContain(html, 'styles.css?v=schedule-print-landscape-52');
mustContain(html, 'core.js?v=schedule-print-landscape-52');
mustContain(html, 'app.js?v=schedule-print-landscape-52');
mustContain(html, 'core.js?v=schedule-print-landscape-52');
...
mustContain(dashboardSource, 'schedule-print-landscape-52', 'Dashboard iframe cache-bust token must match the online staff login asset.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=schedule-print-landscape-52') && index.includes('core.js?v=schedule-print-landscape-52') && index.includes('app.js?v=schedule-print-landscape-52'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
