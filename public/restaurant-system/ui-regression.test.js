...
assert(app.includes('./assets/restaurant-system-logo.png?v=header-left-attendance-clear-38') && app.includes('alt="لوگوی سامانه رستوران"'), 'لوگوی هدر باید از عکس ارسالی کاربر به عنوان لوگوی سامانه استفاده کند');
...
mustContain(html, 'styles.css?v=header-left-attendance-clear-38');
mustContain(html, 'core.js?v=header-left-attendance-clear-38');
mustContain(html, 'app.js?v=header-left-attendance-clear-38');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=header-left-attendance-clear-38') && index.includes('core.js?v=header-left-attendance-clear-38') && index.includes('app.js?v=header-left-attendance-clear-38'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
