...
mustContain(html, 'styles.css?v=pos-cat-strip-real-6');
mustContain(html, 'core.js?v=pos-cat-strip-real-6');
mustContain(html, 'app.js?v=pos-cat-strip-real-6');
