...
mustContain(html, 'styles.css?v=cashier-red-priority-after-submit-155');
mustContain(html, 'core.js?v=cashier-red-priority-after-submit-155');
mustContain(html, 'app.js?v=cashier-red-priority-after-submit-155');
mustContain(html, 'core.js?v=cashier-red-priority-after-submit-155');
...
mustContain(app, 'cashier-red-priority-after-submit-155', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-red-priority-after-submit-155', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'cashier-red-priority-after-submit-155', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-red-priority-after-submit-155') && index.includes('core.js?v=cashier-red-priority-after-submit-155') && index.includes('app.js?v=cashier-red-priority-after-submit-155'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
