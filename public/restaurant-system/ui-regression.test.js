...
mustContain(html, 'styles.css?v=qr-order-guard-112');
mustContain(html, 'core.js?v=qr-order-guard-112');
mustContain(html, 'app.js?v=qr-order-guard-112');
mustContain(html, 'core.js?v=qr-order-guard-112');
...
mustContain(dashboardSource, 'qr-order-guard-112', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=qr-order-guard-112') && index.includes('core.js?v=qr-order-guard-112') && index.includes('app.js?v=qr-order-guard-112'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
