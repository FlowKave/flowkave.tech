...
mustContain(html, 'styles.css?v=selected-tables-wrap-85');
mustContain(html, 'core.js?v=selected-tables-wrap-85');
mustContain(html, 'app.js?v=selected-tables-wrap-85');
mustContain(html, 'core.js?v=selected-tables-wrap-85');
...
mustContain(dashboardSource, 'selected-tables-wrap-85', 'Dashboard iframe cache-bust token must match the selected tables wrap layout change.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=selected-tables-wrap-85') && index.includes('core.js?v=selected-tables-wrap-85') && index.includes('app.js?v=selected-tables-wrap-85'), 'cache-bust چیدمان افقی میزهای انتخاب‌شده باید روی نسخه آنلاین هم اعمال شود');
}
