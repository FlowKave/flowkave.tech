...
mustContain(html, 'styles.css?v=attendance-approval-button-57');
mustContain(html, 'core.js?v=attendance-approval-button-57');
mustContain(html, 'app.js?v=attendance-approval-button-57');
mustContain(html, 'core.js?v=attendance-approval-button-57');
...
mustContain(dashboardSource, 'attendance-approval-button-57', 'Dashboard iframe cache-bust token must match the online staff login asset.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=attendance-approval-button-57') && index.includes('core.js?v=attendance-approval-button-57') && index.includes('app.js?v=attendance-approval-button-57'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
