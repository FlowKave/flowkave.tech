...
assert(app.includes('./assets/restaurant-system-logo.png?v=iran-attendance-time-39') && app.includes('alt="لوگوی سامانه رستوران"'), 'لوگوی هدر باید از عکس ارسالی کاربر به عنوان لوگوی سامانه استفاده کند');
...
mustContain(html, 'styles.css?v=iran-attendance-time-39');
mustContain(html, 'core.js?v=iran-attendance-time-39');
mustContain(html, 'app.js?v=iran-attendance-time-39');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=iran-attendance-time-39') && index.includes('core.js?v=iran-attendance-time-39') && index.includes('app.js?v=iran-attendance-time-39'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
