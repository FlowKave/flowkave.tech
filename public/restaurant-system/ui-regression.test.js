...
mustContain(html, 'styles.css?v=weekly-print-table-fa-55');
mustContain(html, 'core.js?v=weekly-print-table-fa-55');
mustContain(html, 'app.js?v=weekly-print-table-fa-55');
mustContain(html, 'core.js?v=weekly-print-table-fa-55');
...
mustContain(dashboardSource, 'weekly-print-table-fa-55', 'Dashboard iframe cache-bust token must match the online staff login asset.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=weekly-print-table-fa-55') && index.includes('core.js?v=weekly-print-table-fa-55') && index.includes('app.js?v=weekly-print-table-fa-55'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
