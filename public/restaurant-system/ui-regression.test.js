...
mustContain(html, 'styles.css?v=selected-tables-match-trigger-89');
mustContain(html, 'core.js?v=selected-tables-match-trigger-89');
mustContain(html, 'app.js?v=selected-tables-match-trigger-89');
mustContain(html, 'core.js?v=selected-tables-match-trigger-89');
...
mustContain(styles, 'button.hall-occupied-table-chip{min-height:58px!important;padding:7px 12px!important;border-radius:18px!important;font-size:18px!important', 'دکمه میز انتخاب‌شده باید از نظر کلفتی و متن مثل دکمه انتخاب میز باشد.');
...
mustContain(dashboardSource, 'selected-tables-match-trigger-89', 'Dashboard iframe cache-bust token must match the selected table button size change.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=selected-tables-match-trigger-89') && index.includes('core.js?v=selected-tables-match-trigger-89') && index.includes('app.js?v=selected-tables-match-trigger-89'), 'cache-bust هم‌اندازه‌کردن دکمه میز انتخاب‌شده باید روی نسخه آنلاین هم اعمال شود');
}
