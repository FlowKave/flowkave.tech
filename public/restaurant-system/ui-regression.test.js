...
mustContain(html, 'styles.css?v=cashier-payment-items-dropdown-183');
mustContain(html, 'core.js?v=cashier-payment-items-dropdown-183');
mustContain(html, 'app.js?v=cashier-payment-items-dropdown-183');
mustContain(html, 'core.js?v=cashier-payment-items-dropdown-183');
...
mustContain(app, 'cashier-payment-items-dropdown-183', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-payment-items-dropdown-183', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(app, '<details class="hall-remaining-list hall-remaining-dropdown">', 'آیتم‌های پرداخت باید داخل dropdown کشویی باشند.');
...
mustContain(dashboardSource, 'cashier-payment-items-dropdown-183', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-payment-items-dropdown-183') && index.includes('core.js?v=cashier-payment-items-dropdown-183') && index.includes('app.js?v=cashier-payment-items-dropdown-183'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
