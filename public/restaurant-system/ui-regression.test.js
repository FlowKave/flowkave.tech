...
mustContain(html, 'styles.css?v=cashier-pos-write-confirm-125');
mustContain(html, 'core.js?v=cashier-pos-write-confirm-125');
mustContain(html, 'app.js?v=cashier-pos-write-confirm-125');
mustContain(html, 'core.js?v=cashier-pos-write-confirm-125');
...
mustContain(dashboardSource, 'cashier-pos-write-confirm-125', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-pos-write-confirm-125') && index.includes('core.js?v=cashier-pos-write-confirm-125') && index.includes('app.js?v=cashier-pos-write-confirm-125'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
