...
assert(app.includes('./assets/restaurant-system-logo.png?v=staff-attendance-modal-36') && app.includes('alt="لوگوی سامانه رستوران"'), 'لوگوی هدر باید از عکس ارسالی کاربر به عنوان لوگوی سامانه استفاده کند');
...
mustContain(html, 'styles.css?v=staff-attendance-modal-36');
mustContain(html, 'core.js?v=staff-attendance-modal-36');
mustContain(html, 'app.js?v=staff-attendance-modal-36');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=staff-attendance-modal-36') && index.includes('core.js?v=staff-attendance-modal-36') && index.includes('app.js?v=staff-attendance-modal-36'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
