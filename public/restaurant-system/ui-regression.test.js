...
mustContain(html, 'styles.css?v=attendance-buttons-visible-48');
mustContain(html, 'core.js?v=attendance-buttons-visible-48');
mustContain(html, 'app.js?v=attendance-buttons-visible-48');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=attendance-buttons-visible-48') && index.includes('core.js?v=attendance-buttons-visible-48') && index.includes('app.js?v=attendance-buttons-visible-48'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
