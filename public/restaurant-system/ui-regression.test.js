...
mustContain(html, 'styles.css?v=occupied-tables-box-83');
mustContain(html, 'core.js?v=occupied-tables-box-83');
mustContain(html, 'app.js?v=occupied-tables-box-83');
mustContain(html, 'core.js?v=occupied-tables-box-83');
...
mustContain(dashboardSource, 'occupied-tables-box-83', 'Dashboard iframe cache-bust token must match the occupied tables box change.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=occupied-tables-box-83') && index.includes('core.js?v=occupied-tables-box-83') && index.includes('app.js?v=occupied-tables-box-83'), 'cache-bust باکس میزهای درگیر باید روی نسخه آنلاین هم اعمال شود');
}
