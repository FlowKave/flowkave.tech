...
mustContain(html, 'styles.css?v=cashier-manager-staff-lock-sync-158');
mustContain(html, 'core.js?v=cashier-manager-staff-lock-sync-158');
mustContain(html, 'app.js?v=cashier-manager-staff-lock-sync-158');
mustContain(html, 'core.js?v=cashier-manager-staff-lock-sync-158');
...
mustContain(app, 'cashier-manager-staff-lock-sync-158', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-manager-staff-lock-sync-158', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'cashier-manager-staff-lock-sync-158', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-manager-staff-lock-sync-158') && index.includes('core.js?v=cashier-manager-staff-lock-sync-158') && index.includes('app.js?v=cashier-manager-staff-lock-sync-158'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
