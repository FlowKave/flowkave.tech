...
assert(app.includes('./assets/restaurant-system-logo.png?v=header-attendance-icon-37') && app.includes('alt="لوگوی سامانه رستوران"'), 'لوگوی هدر باید از عکس ارسالی کاربر به عنوان لوگوی سامانه استفاده کند');
...
mustContain(html, 'styles.css?v=header-attendance-icon-37');
mustContain(html, 'core.js?v=header-attendance-icon-37');
mustContain(html, 'app.js?v=header-attendance-icon-37');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=header-attendance-icon-37') && index.includes('core.js?v=header-attendance-icon-37') && index.includes('app.js?v=header-attendance-icon-37'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
