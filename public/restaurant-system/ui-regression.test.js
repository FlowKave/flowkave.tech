...
mustContain(html, 'styles.css?v=public-delete-tombstone-122');
mustContain(html, 'core.js?v=public-delete-tombstone-122');
mustContain(html, 'app.js?v=public-delete-tombstone-122');
mustContain(html, 'core.js?v=public-delete-tombstone-122');
...
mustContain(dashboardSource, 'public-delete-tombstone-122', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=public-delete-tombstone-122') && index.includes('core.js?v=public-delete-tombstone-122') && index.includes('app.js?v=public-delete-tombstone-122'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
