...
assert(app.includes('./assets/restaurant-system-logo.png?v=attendance-management-table-40') && app.includes('alt="لوگوی سامانه رستوران"'), 'لوگوی هدر باید از عکس ارسالی کاربر به عنوان لوگوی سامانه استفاده کند');
...
mustContain(html, 'styles.css?v=attendance-management-table-40');
mustContain(html, 'core.js?v=attendance-management-table-40');
mustContain(html, 'app.js?v=attendance-management-table-40');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=attendance-management-table-40') && index.includes('core.js?v=attendance-management-table-40') && index.includes('app.js?v=attendance-management-table-40'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
