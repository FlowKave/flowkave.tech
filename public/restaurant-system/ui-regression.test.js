...
mustContain(html, 'styles.css?v=staff-invite-email-62');
mustContain(html, 'core.js?v=staff-invite-email-62');
mustContain(html, 'app.js?v=staff-invite-email-62');
mustContain(html, 'core.js?v=staff-invite-email-62');
...
mustContain(dashboardSource, 'staff-invite-email-62', 'Dashboard iframe cache-bust token must match the online staff login asset.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=staff-invite-email-62') && index.includes('core.js?v=staff-invite-email-62') && index.includes('app.js?v=staff-invite-email-62'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
