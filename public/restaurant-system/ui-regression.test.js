...
mustContain(html, 'styles.css?v=public-order-merge-fix-121');
mustContain(html, 'core.js?v=public-order-merge-fix-121');
mustContain(html, 'app.js?v=public-order-merge-fix-121');
mustContain(html, 'core.js?v=public-order-merge-fix-121');
...
mustContain(dashboardSource, 'public-order-merge-fix-121', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=public-order-merge-fix-121') && index.includes('core.js?v=public-order-merge-fix-121') && index.includes('app.js?v=public-order-merge-fix-121'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
