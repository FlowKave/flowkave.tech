...
mustContain(html, 'styles.css?v=hall-receipt-visible-submit-label-128');
mustContain(html, 'core.js?v=hall-receipt-visible-submit-label-128');
mustContain(html, 'app.js?v=hall-receipt-visible-submit-label-128');
mustContain(html, 'core.js?v=hall-receipt-visible-submit-label-128');
...
mustContain(publicRestaurantStateApiSource, "for (const key of ['shifts', 'ledger', 'restaurantTables'])", 'endpoint عمومی باید روز کاری صندوق، ledger و میزهای موجود سرور را با state تبلت merge کند.');
...
mustContain(dashboardSource, 'hall-receipt-visible-submit-label-128', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=hall-receipt-visible-submit-label-128') && index.includes('core.js?v=hall-receipt-visible-submit-label-128') && index.includes('app.js?v=hall-receipt-visible-submit-label-128'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
