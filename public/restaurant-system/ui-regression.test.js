...
mustContain(html, 'styles.css?v=cashier-payment-service-default-176');
mustContain(html, 'core.js?v=cashier-payment-service-default-176');
mustContain(html, 'app.js?v=cashier-payment-service-default-176');
mustContain(html, 'core.js?v=cashier-payment-service-default-176');
...
mustContain(app, 'cashier-payment-service-default-176', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-payment-service-default-176', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(app, 'حق سرویس — محاسبه درصدی', 'کلمه حق سرویس باید در یک لاین کنار محاسبه درصدی قرار بگیرد.');
...
mustContain(dashboardSource, 'cashier-payment-service-default-176', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-payment-service-default-176') && index.includes('core.js?v=cashier-payment-service-default-176') && index.includes('app.js?v=cashier-payment-service-default-176'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
