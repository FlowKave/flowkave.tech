...
mustContain(html, 'styles.css?v=pos-fixed-dual-lines-8');
mustContain(html, 'core.js?v=pos-fixed-dual-lines-8');
mustContain(html, 'app.js?v=pos-fixed-dual-lines-8');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=pos-fixed-dual-lines-8') && index.includes('core.js?v=pos-fixed-dual-lines-8') && index.includes('app.js?v=pos-fixed-dual-lines-8'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
