...
mustContain(html, 'styles.css?v=mobile-table-qr-105');
mustContain(html, 'core.js?v=mobile-table-qr-105');
mustContain(html, 'app.js?v=mobile-table-qr-105');
mustContain(html, 'core.js?v=mobile-table-qr-105');
...
mustContain(dashboardSource, 'mobile-table-qr-105', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=mobile-table-qr-105') && index.includes('core.js?v=mobile-table-qr-105') && index.includes('app.js?v=mobile-table-qr-105'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
