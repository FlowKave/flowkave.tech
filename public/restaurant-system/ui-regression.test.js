...
mustContain(html, 'styles.css?v=cashier-payment-centered-scroll-185');
mustContain(html, 'core.js?v=cashier-payment-centered-scroll-185');
mustContain(html, 'app.js?v=cashier-payment-centered-scroll-185');
mustContain(html, 'core.js?v=cashier-payment-centered-scroll-185');
...
mustContain(app, 'cashier-payment-centered-scroll-185', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-payment-centered-scroll-185', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(styles, '.hall-payment-popup-backdrop{position:fixed!important;inset:0!important;z-index:175!important;display:flex!important;align-items:center!important;justify-content:center!important', 'popup پرداخت باید وسط مانیتور باز شود نه از بالای صفحه.');
mustContain(styles, 'Hall payment popup centered viewport and scroll retention.', 'popup پرداخت باید مرکز viewport و scroll داخلی پایدار داشته باشد.');
mustContain(styles, '.hall-payment-popup-scroll{max-height:calc(100vh - 128px)!important;overscroll-behavior:contain!important;scrollbar-width:thin!important}', 'scroll داخلی popup باید مستقل و قابل نگهداری باشد.');
...
mustContain(dashboardSource, 'cashier-payment-centered-scroll-185', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-payment-centered-scroll-185') && index.includes('core.js?v=cashier-payment-centered-scroll-185') && index.includes('app.js?v=cashier-payment-centered-scroll-185'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
