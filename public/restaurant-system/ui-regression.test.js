...
mustContain(html, 'styles.css?v=weekly-jalali-schedule-grid-28');
mustContain(html, 'core.js?v=weekly-jalali-schedule-grid-28');
mustContain(html, 'app.js?v=weekly-jalali-schedule-grid-28');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=weekly-jalali-schedule-grid-28') && index.includes('core.js?v=weekly-jalali-schedule-grid-28') && index.includes('app.js?v=weekly-jalali-schedule-grid-28'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
