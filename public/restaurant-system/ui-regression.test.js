...
assert(app.includes('./assets/restaurant-system-logo.png?v=system-logo-hq-png-33') && app.includes('alt="لوگوی سامانه رستوران"'), 'لوگوی هدر باید از عکس ارسالی کاربر به عنوان لوگوی سامانه استفاده کند');
...
mustContain(html, 'styles.css?v=system-logo-hq-png-33');
mustContain(html, 'core.js?v=system-logo-hq-png-33');
mustContain(html, 'app.js?v=system-logo-hq-png-33');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=system-logo-hq-png-33') && index.includes('core.js?v=system-logo-hq-png-33') && index.includes('app.js?v=system-logo-hq-png-33'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
