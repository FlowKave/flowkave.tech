...
mustContain(html, 'styles.css?v=staff-invite-accept-64');
mustContain(html, 'core.js?v=staff-invite-accept-64');
mustContain(html, 'app.js?v=staff-invite-accept-64');
mustContain(html, 'core.js?v=staff-invite-accept-64');
...
mustContain(dashboardSource, 'staff-invite-accept-64', 'Dashboard iframe cache-bust token must match the online staff login asset.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=staff-invite-accept-64') && index.includes('core.js?v=staff-invite-accept-64') && index.includes('app.js?v=staff-invite-accept-64'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
