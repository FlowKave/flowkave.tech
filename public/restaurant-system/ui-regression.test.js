...
mustContain(html, 'styles.css?v=auth-tablet-sync-merge-124');
mustContain(html, 'core.js?v=auth-tablet-sync-merge-124');
mustContain(html, 'app.js?v=auth-tablet-sync-merge-124');
mustContain(html, 'core.js?v=auth-tablet-sync-merge-124');
...
mustContain(dashboardSource, 'auth-tablet-sync-merge-124', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=auth-tablet-sync-merge-124') && index.includes('core.js?v=auth-tablet-sync-merge-124') && index.includes('app.js?v=auth-tablet-sync-merge-124'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
