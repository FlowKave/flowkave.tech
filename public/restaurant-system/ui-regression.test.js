...
mustContain(html, 'styles.css?v=staff-invite-email-61');
mustContain(html, 'core.js?v=staff-invite-email-61');
mustContain(html, 'app.js?v=staff-invite-email-61');
mustContain(html, 'core.js?v=staff-invite-email-61');
...
mustContain(dashboardSource, 'staff-invite-email-61', 'Dashboard iframe cache-bust token must match the online staff login asset.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=staff-invite-email-61') && index.includes('core.js?v=staff-invite-email-61') && index.includes('app.js?v=staff-invite-email-61'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
