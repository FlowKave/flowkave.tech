...
mustContain(html, 'styles.css?v=order-preview-details-202');
mustContain(html, 'core.js?v=order-preview-details-202');
mustContain(html, 'app.js?v=order-preview-details-202');
mustContain(html, 'core.js?v=order-preview-details-202');
...
mustContain(app, 'order-preview-details-202', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'order-preview-details-202', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'order-preview-details-202', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=order-preview-details-202') && index.includes('core.js?v=order-preview-details-202') && index.includes('app.js?v=order-preview-details-202'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
...
assert(html.includes('app.js?v=order-preview-details-202') && html.includes('styles.css?v=order-preview-details-202'), 'Restaurant static app must cache-bust order preview deploy.');
