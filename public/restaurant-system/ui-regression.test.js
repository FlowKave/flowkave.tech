...
mustContain(html, 'styles.css?v=pos-table-status-fixed-10');
mustContain(html, 'core.js?v=pos-table-status-fixed-10');
mustContain(html, 'app.js?v=pos-table-status-fixed-10');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=pos-table-status-fixed-10') && index.includes('core.js?v=pos-table-status-fixed-10') && index.includes('app.js?v=pos-table-status-fixed-10'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
