...
mustContain(html, 'styles.css?v=sync-unlock-110');
mustContain(html, 'core.js?v=sync-unlock-110');
mustContain(html, 'app.js?v=sync-unlock-110');
mustContain(html, 'core.js?v=sync-unlock-110');
...
mustContain(dashboardSource, 'sync-unlock-110', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=sync-unlock-110') && index.includes('core.js?v=sync-unlock-110') && index.includes('app.js?v=sync-unlock-110'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
