...
mustContain(html, 'styles.css?v=live-service-summary-103');
mustContain(html, 'core.js?v=live-service-summary-103');
mustContain(html, 'app.js?v=live-service-summary-103');
mustContain(html, 'core.js?v=live-service-summary-103');
...
mustContain(dashboardSource, 'live-service-summary-103', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=live-service-summary-103') && index.includes('core.js?v=live-service-summary-103') && index.includes('app.js?v=live-service-summary-103'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
