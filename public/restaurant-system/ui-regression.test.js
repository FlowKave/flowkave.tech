...
mustContain(html, 'styles.css?v=owner-manager-tenant-switch-visible-74');
mustContain(html, 'core.js?v=owner-manager-tenant-switch-visible-74');
mustContain(html, 'app.js?v=owner-manager-tenant-switch-visible-74');
mustContain(html, 'core.js?v=owner-manager-tenant-switch-visible-74');
...
mustContain(dashboardSource, 'owner-manager-tenant-switch-visible-74', 'Dashboard iframe cache-bust token must match the online multi-restaurant manager invite fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=owner-manager-tenant-switch-visible-74') && index.includes('core.js?v=owner-manager-tenant-switch-visible-74') && index.includes('app.js?v=owner-manager-tenant-switch-visible-74'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
