...
mustContain(html, 'styles.css?v=cashier-rollback-5h-164');
mustContain(html, 'core.js?v=cashier-rollback-5h-164');
mustContain(html, 'app.js?v=cashier-rollback-5h-164');
mustContain(html, 'core.js?v=cashier-rollback-5h-164');
...
mustContain(app, 'cashier-rollback-5h-164', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-rollback-5h-164', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'cashier-rollback-5h-164', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-rollback-5h-164') && index.includes('core.js?v=cashier-rollback-5h-164') && index.includes('app.js?v=cashier-rollback-5h-164'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
