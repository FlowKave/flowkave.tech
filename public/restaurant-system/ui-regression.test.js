...
mustContain(html, 'styles.css?v=online-staff-login-49');
mustContain(html, 'core.js?v=online-staff-login-49');
mustContain(html, 'app.js?v=online-staff-login-49');
mustContain(html, 'core.js?v=online-staff-login-49');
...
mustContain(dashboardSource, 'online-staff-login-49', 'Dashboard iframe cache-bust token must match the online staff login asset.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=online-staff-login-49') && index.includes('core.js?v=online-staff-login-49') && index.includes('app.js?v=online-staff-login-49'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
