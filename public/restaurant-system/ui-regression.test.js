...
mustContain(html, 'styles.css?v=pos-fixed-dual-lines-online-9');
mustContain(html, 'core.js?v=pos-fixed-dual-lines-online-9');
mustContain(html, 'app.js?v=pos-fixed-dual-lines-online-9');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=pos-fixed-dual-lines-online-9') && index.includes('core.js?v=pos-fixed-dual-lines-online-9') && index.includes('app.js?v=pos-fixed-dual-lines-online-9'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
