...
mustContain(html, 'styles.css?v=cashier-payment-header-buttons-175');
mustContain(html, 'core.js?v=cashier-payment-header-buttons-175');
mustContain(html, 'app.js?v=cashier-payment-header-buttons-175');
mustContain(html, 'core.js?v=cashier-payment-header-buttons-175');
...
mustContain(app, 'cashier-payment-header-buttons-175', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-payment-header-buttons-175', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'cashier-payment-header-buttons-175', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-payment-header-buttons-175') && index.includes('core.js?v=cashier-payment-header-buttons-175') && index.includes('app.js?v=cashier-payment-header-buttons-175'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
