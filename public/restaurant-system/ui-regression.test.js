...
mustContain(html, 'styles.css?v=cashier-preserve-local-table-lock-152');
mustContain(html, 'core.js?v=cashier-preserve-local-table-lock-152');
mustContain(html, 'app.js?v=cashier-preserve-local-table-lock-152');
mustContain(html, 'core.js?v=cashier-preserve-local-table-lock-152');
...
mustContain(app, 'cashier-preserve-local-table-lock-152', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-preserve-local-table-lock-152', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'cashier-preserve-local-table-lock-152', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-preserve-local-table-lock-152') && index.includes('core.js?v=cashier-preserve-local-table-lock-152') && index.includes('app.js?v=cashier-preserve-local-table-lock-152'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
