...
mustContain(html, 'styles.css?v=cashier-table-layout-replace-171');
mustContain(html, 'core.js?v=cashier-table-layout-replace-171');
mustContain(html, 'app.js?v=cashier-table-layout-replace-171');
mustContain(html, 'core.js?v=cashier-table-layout-replace-171');
...
mustContain(app, 'cashier-table-layout-replace-171', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-table-layout-replace-171', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'cashier-table-layout-replace-171', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-table-layout-replace-171') && index.includes('core.js?v=cashier-table-layout-replace-171') && index.includes('app.js?v=cashier-table-layout-replace-171'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
