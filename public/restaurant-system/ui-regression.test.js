...
mustContain(html, 'styles.css?v=cashier-payment-popup-topfit-186');
mustContain(html, 'core.js?v=cashier-payment-popup-topfit-186');
mustContain(html, 'app.js?v=cashier-payment-popup-topfit-186');
mustContain(html, 'core.js?v=cashier-payment-popup-topfit-186');
...
mustContain(app, 'cashier-payment-popup-topfit-186', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-payment-popup-topfit-186', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(styles, '.hall-payment-popup-backdrop{position:fixed!important;inset:0!important;z-index:175!important;display:flex!important;align-items:flex-start!important;justify-content:center!important;padding:clamp(10px,3vh,24px) clamp(14px,3vw,30px)!important', 'popup پرداخت باید از بالای viewport با فاصله کم باز شود تا پایینش قطع نشود.');
mustContain(styles, 'Hall payment popup top-fit viewport and scroll retention.', 'popup پرداخت باید بالاتر fit شود و scroll داخلی پایدار داشته باشد.');
mustContain(styles, '.hall-payment-popup-scroll{max-height:calc(100vh - 112px)!important;overscroll-behavior:contain!important;scrollbar-width:thin!important}', 'scroll داخلی popup باید مستقل و قابل نگهداری باشد و پایین popup قطع نشود.');
mustContain(styles, '.hall-payment-popup{max-height:calc(100vh - 32px)!important;margin-top:0!important}', 'ارتفاع خود popup باید داخل viewport fit شود.');
...
mustContain(dashboardSource, 'cashier-payment-popup-topfit-186', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-payment-popup-topfit-186') && index.includes('core.js?v=cashier-payment-popup-topfit-186') && index.includes('app.js?v=cashier-payment-popup-topfit-186'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
