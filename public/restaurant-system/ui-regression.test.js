...
mustContain(html, 'styles.css?v=occupied-tables-inline-84');
mustContain(html, 'core.js?v=occupied-tables-inline-84');
mustContain(html, 'app.js?v=occupied-tables-inline-84');
mustContain(html, 'core.js?v=occupied-tables-inline-84');
...
mustContain(styles, '.hall-occupied-tables-scroll{min-height:0!important;max-height:82px!important;overflow-y:auto!important;overflow-x:hidden!important;display:flex!important;flex-wrap:wrap!important', 'میزهای انتخاب‌شده باید افقی کنار هم بچینند، دو خط دیده شود و از خط سوم اسکرول عمودی شود.');
...
mustContain(dashboardSource, 'occupied-tables-inline-84', 'Dashboard iframe cache-bust token must match the occupied tables inline layout change.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=occupied-tables-inline-84') && index.includes('core.js?v=occupied-tables-inline-84') && index.includes('app.js?v=occupied-tables-inline-84'), 'cache-bust چیدمان افقی میزهای انتخاب‌شده باید روی نسخه آنلاین هم اعمال شود');
}
