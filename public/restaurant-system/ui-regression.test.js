...
mustContain(html, 'styles.css?v=qr-sync-query-fix-108');
mustContain(html, 'core.js?v=qr-sync-query-fix-108');
mustContain(html, 'app.js?v=qr-sync-query-fix-108');
mustContain(html, 'core.js?v=qr-sync-query-fix-108');
...
mustContain(dashboardSource, 'qr-sync-query-fix-108', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=qr-sync-query-fix-108') && index.includes('core.js?v=qr-sync-query-fix-108') && index.includes('app.js?v=qr-sync-query-fix-108'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
