...
mustContain(html, 'styles.css?v=cashier-live-qr-sync-109');
mustContain(html, 'core.js?v=cashier-live-qr-sync-109');
mustContain(html, 'app.js?v=cashier-live-qr-sync-109');
mustContain(html, 'core.js?v=cashier-live-qr-sync-109');
...
mustContain(dashboardSource, 'cashier-live-qr-sync-109', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-live-qr-sync-109') && index.includes('core.js?v=cashier-live-qr-sync-109') && index.includes('app.js?v=cashier-live-qr-sync-109'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
