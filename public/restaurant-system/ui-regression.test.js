...
mustContain(html, 'styles.css?v=hall-draft-release-button-133');
mustContain(html, 'core.js?v=hall-draft-release-button-133');
mustContain(html, 'app.js?v=hall-draft-release-button-133');
mustContain(html, 'core.js?v=hall-draft-release-button-133');
...
mustContain(dashboardSource, 'hall-draft-release-button-133', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=hall-draft-release-button-133') && index.includes('core.js?v=hall-draft-release-button-133') && index.includes('app.js?v=hall-draft-release-button-133'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
