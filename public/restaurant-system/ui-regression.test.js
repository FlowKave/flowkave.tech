...
assert(app.includes('./assets/restaurant-system-logo.png?v=attendance-clockout-display-41') && app.includes('alt="لوگوی سامانه رستوران"'), 'لوگوی هدر باید از عکس ارسالی کاربر به عنوان لوگوی سامانه استفاده کند');
...
mustContain(html, 'styles.css?v=attendance-clockout-display-41');
mustContain(html, 'core.js?v=attendance-clockout-display-41');
mustContain(html, 'app.js?v=attendance-clockout-display-41');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=attendance-clockout-display-41') && index.includes('core.js?v=attendance-clockout-display-41') && index.includes('app.js?v=attendance-clockout-display-41'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
