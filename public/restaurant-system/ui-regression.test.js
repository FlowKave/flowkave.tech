...
mustContain(html, 'styles.css?v=pos-turnover-center-139');
mustContain(html, 'core.js?v=pos-turnover-center-139');
mustContain(html, 'app.js?v=pos-turnover-center-139');
mustContain(html, 'core.js?v=pos-turnover-center-139');
...
mustContain(app, 'pos-turnover-center-139', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'pos-turnover-center-139', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'pos-turnover-center-139', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=pos-turnover-center-139') && index.includes('core.js?v=pos-turnover-center-139') && index.includes('app.js?v=pos-turnover-center-139'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
