...
assert(app.includes('./assets/restaurant-system-logo.png?v=system-logo-hq-zoom-34') && app.includes('alt="لوگوی سامانه رستوران"'), 'لوگوی هدر باید از عکس ارسالی کاربر به عنوان لوگوی سامانه استفاده کند');
...
assert(styles.includes('.app-logo.restaurant-graphic-logo img') && styles.includes('object-fit:cover!important'), 'لوگوی تصویری باید با CSS مناسب داخل هدر نمایش داده شود');
assert(styles.includes('transform:scale(1.42)!important') && styles.includes('overflow:hidden!important'), 'لوگوی PNG باید برای حذف فضای آزاد دور تصویر زوم شود و جلوتر دیده شود');
...
mustContain(html, 'styles.css?v=system-logo-hq-zoom-34');
mustContain(html, 'core.js?v=system-logo-hq-zoom-34');
mustContain(html, 'app.js?v=system-logo-hq-zoom-34');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=system-logo-hq-zoom-34') && index.includes('core.js?v=system-logo-hq-zoom-34') && index.includes('app.js?v=system-logo-hq-zoom-34'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
