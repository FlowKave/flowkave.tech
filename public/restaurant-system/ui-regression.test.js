...
mustContain(html, 'styles.css?v=cashier-actions-header-145');
mustContain(html, 'core.js?v=cashier-actions-header-145');
mustContain(html, 'app.js?v=cashier-actions-header-145');
mustContain(html, 'core.js?v=cashier-actions-header-145');
...
mustContain(app, 'cashier-actions-header-145', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(styles, '.hall-sale-table-title .hall-order-title-actions>button{min-width:128px!important', 'دکمه‌های ثبت سفارش و آزاد کردن باید داخل همان لاین عنوان میز استایل شوند.');
...
mustContain(app, 'cashier-actions-header-145', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(app, '<div class="hall-sale-table-title"><span>ثبت سفارش میز ${esc(selectedTable.name)}</span>${orderActions}</div>', 'دکمه ثبت سفارش و آزاد کردن باید کنار عنوان ثبت سفارش میز باشد تا نیاز به اسکرول پایین نباشد.');
...
mustContain(dashboardSource, 'cashier-actions-header-145', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-actions-header-145') && index.includes('core.js?v=cashier-actions-header-145') && index.includes('app.js?v=cashier-actions-header-145'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
