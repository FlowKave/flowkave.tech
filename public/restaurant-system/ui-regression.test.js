...
mustContain(html, 'styles.css?v=attendance-status-icon-58');
mustContain(html, 'core.js?v=attendance-status-icon-58');
mustContain(html, 'app.js?v=attendance-status-icon-58');
mustContain(html, 'core.js?v=attendance-status-icon-58');
...
mustContain(dashboardSource, 'attendance-status-icon-58', 'Dashboard iframe cache-bust token must match the online staff login asset.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=attendance-status-icon-58') && index.includes('core.js?v=attendance-status-icon-58') && index.includes('app.js?v=attendance-status-icon-58'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
