...
mustContain(html, 'styles.css?v=public-delete-infer-123');
mustContain(html, 'core.js?v=public-delete-infer-123');
mustContain(html, 'app.js?v=public-delete-infer-123');
mustContain(html, 'core.js?v=public-delete-infer-123');
...
mustContain(dashboardSource, 'public-delete-infer-123', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=public-delete-infer-123') && index.includes('core.js?v=public-delete-infer-123') && index.includes('app.js?v=public-delete-infer-123'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
