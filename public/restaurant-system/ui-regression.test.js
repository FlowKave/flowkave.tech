...
mustContain(html, 'styles.css?v=cashier-qr-preorder-table-lock-169');
mustContain(html, 'core.js?v=cashier-qr-preorder-table-lock-169');
mustContain(html, 'app.js?v=cashier-qr-preorder-table-lock-169');
mustContain(html, 'core.js?v=cashier-qr-preorder-table-lock-169');
...
mustContain(app, 'cashier-qr-preorder-table-lock-169', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-qr-preorder-table-lock-169', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'cashier-qr-preorder-table-lock-169', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-qr-preorder-table-lock-169') && index.includes('core.js?v=cashier-qr-preorder-table-lock-169') && index.includes('app.js?v=cashier-qr-preorder-table-lock-169'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
