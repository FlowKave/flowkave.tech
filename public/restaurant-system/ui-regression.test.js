...
mustContain(html, 'styles.css?v=hall-table-shared-lock-129');
mustContain(html, 'core.js?v=hall-table-shared-lock-129');
mustContain(html, 'app.js?v=hall-table-shared-lock-129');
mustContain(html, 'core.js?v=hall-table-shared-lock-129');
...
mustContain(app, 'RestaurantCore.deleteSale(state, customer.id, btn.dataset.deleteSale); await persistCriticalState(); render();', 'حذف سفارش در صندوق باید ذخیره سرور را await کند.');
...
mustContain(dashboardSource, 'hall-table-shared-lock-129', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=hall-table-shared-lock-129') && index.includes('core.js?v=hall-table-shared-lock-129') && index.includes('app.js?v=hall-table-shared-lock-129'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
