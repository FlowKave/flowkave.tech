...
mustContain(html, 'styles.css?v=cashier-payment-method-layer-198');
mustContain(html, 'core.js?v=cashier-payment-method-layer-198');
mustContain(html, 'app.js?v=cashier-payment-method-layer-198');
mustContain(html, 'core.js?v=cashier-payment-method-layer-198');
...
mustContain(app, 'cashier-payment-method-layer-198', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-payment-method-layer-198', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(app, "if (paidOrder?.posStatus === 'paid' && paidOrder.tableHeldAfterPayment !== true) hallPaymentPopupOrderId = '';", 'بعد از پرداخت و آزاد کردن میز، popup پرداخت باید بسته شود بدون تغییر منطق آزادسازی.');
...
mustContain(dashboardSource, 'cashier-payment-method-layer-198', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-payment-method-layer-198') && index.includes('core.js?v=cashier-payment-method-layer-198') && index.includes('app.js?v=cashier-payment-method-layer-198'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
