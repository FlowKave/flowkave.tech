...
mustContain(html, 'styles.css?v=portal-preauth-dashboard-11');
mustContain(html, 'core.js?v=portal-preauth-dashboard-11');
mustContain(html, 'app.js?v=portal-preauth-dashboard-11');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=portal-preauth-dashboard-11') && index.includes('core.js?v=portal-preauth-dashboard-11') && index.includes('app.js?v=portal-preauth-dashboard-11'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
