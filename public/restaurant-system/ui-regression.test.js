...
mustContain(html, 'styles.css?v=public-paid-sync-version-120');
mustContain(html, 'core.js?v=public-paid-sync-version-120');
mustContain(html, 'app.js?v=public-paid-sync-version-120');
mustContain(html, 'core.js?v=public-paid-sync-version-120');
...
mustContain(dashboardSource, 'public-paid-sync-version-120', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=public-paid-sync-version-120') && index.includes('core.js?v=public-paid-sync-version-120') && index.includes('app.js?v=public-paid-sync-version-120'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
