...
mustContain(html, 'styles.css?v=qr-loading-fix-107');
mustContain(html, 'core.js?v=qr-loading-fix-107');
mustContain(html, 'app.js?v=qr-loading-fix-107');
mustContain(html, 'core.js?v=qr-loading-fix-107');
...
mustContain(dashboardSource, 'qr-loading-fix-107', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=qr-loading-fix-107') && index.includes('core.js?v=qr-loading-fix-107') && index.includes('app.js?v=qr-loading-fix-107'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
