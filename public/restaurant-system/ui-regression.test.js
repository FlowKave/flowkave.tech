...
mustContain(html, 'styles.css?v=hall-ticket-total-82');
mustContain(html, 'core.js?v=hall-ticket-total-82');
mustContain(html, 'app.js?v=hall-ticket-total-82');
mustContain(html, 'core.js?v=hall-ticket-total-82');
...
mustContain(dashboardSource, 'hall-ticket-total-82', 'Dashboard iframe cache-bust token must match the online hall ticket total change.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=hall-ticket-total-82') && index.includes('core.js?v=hall-ticket-total-82') && index.includes('app.js?v=hall-ticket-total-82'), 'cache-bust جمع مبلغ فیش صندوق باید روی نسخه آنلاین هم اعمال شود');
}
