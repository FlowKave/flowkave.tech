...
mustContain(html, 'styles.css?v=mobile-qr-resolve-106');
mustContain(html, 'core.js?v=mobile-qr-resolve-106');
mustContain(html, 'app.js?v=mobile-qr-resolve-106');
mustContain(html, 'core.js?v=mobile-qr-resolve-106');
...
mustContain(dashboardSource, 'mobile-qr-resolve-106', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=mobile-qr-resolve-106') && index.includes('core.js?v=mobile-qr-resolve-106') && index.includes('app.js?v=mobile-qr-resolve-106'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
