...
mustContain(html, 'styles.css?v=tax-service-settings-100');
mustContain(html, 'core.js?v=tax-service-settings-100');
mustContain(html, 'app.js?v=tax-service-settings-100');
mustContain(html, 'core.js?v=tax-service-settings-100');
...
mustContain(app, 'حق سرویس', 'تنظیمات باید تیک و درصد حق سرویس داشته باشد.');
...
mustContain(dashboardSource, 'tax-service-settings-100', 'Dashboard iframe cache-bust token must match the tax/service settings fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=tax-service-settings-100') && index.includes('core.js?v=tax-service-settings-100') && index.includes('app.js?v=tax-service-settings-100'), 'cache-bust اصلاح مالیات و حق سرویس باید روی نسخه آنلاین هم اعمال شود');
}
