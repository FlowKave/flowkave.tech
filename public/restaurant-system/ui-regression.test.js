...
mustContain(html, 'styles.css?v=cashier-hall-table-state-machine-157');
mustContain(html, 'core.js?v=cashier-hall-table-state-machine-157');
mustContain(html, 'app.js?v=cashier-hall-table-state-machine-157');
mustContain(html, 'core.js?v=cashier-hall-table-state-machine-157');
...
mustContain(app, 'cashier-hall-table-state-machine-157', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-hall-table-state-machine-157', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'cashier-hall-table-state-machine-157', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-hall-table-state-machine-157') && index.includes('core.js?v=cashier-hall-table-state-machine-157') && index.includes('app.js?v=cashier-hall-table-state-machine-157'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
