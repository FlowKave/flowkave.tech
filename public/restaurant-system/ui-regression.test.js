...
mustContain(html, 'styles.css?v=pos-turnover-panels-138');
mustContain(html, 'core.js?v=pos-turnover-panels-138');
mustContain(html, 'app.js?v=pos-turnover-panels-138');
mustContain(html, 'core.js?v=pos-turnover-panels-138');
...
mustContain(app, 'pos-turnover-panels-138', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'pos-turnover-panels-138', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'pos-turnover-panels-138', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=pos-turnover-panels-138') && index.includes('core.js?v=pos-turnover-panels-138') && index.includes('app.js?v=pos-turnover-panels-138'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
