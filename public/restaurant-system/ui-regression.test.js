...
mustContain(html, 'styles.css?v=dashboard-remove-test-path-12');
mustContain(html, 'core.js?v=dashboard-remove-test-path-12');
mustContain(html, 'app.js?v=dashboard-remove-test-path-12');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=dashboard-remove-test-path-12') && index.includes('core.js?v=dashboard-remove-test-path-12') && index.includes('app.js?v=dashboard-remove-test-path-12'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
