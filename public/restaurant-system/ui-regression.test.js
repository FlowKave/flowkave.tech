...
mustContain(html, 'styles.css?v=personnel-modal-invite-fix-77');
mustContain(html, 'core.js?v=personnel-modal-invite-fix-77');
mustContain(html, 'app.js?v=personnel-modal-invite-fix-77');
mustContain(html, 'core.js?v=personnel-modal-invite-fix-77');
...
mustContain(dashboardSource, 'personnel-modal-invite-fix-77', 'Dashboard iframe cache-bust token must match the online multi-restaurant manager invite fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=personnel-modal-invite-fix-77') && index.includes('core.js?v=personnel-modal-invite-fix-77') && index.includes('app.js?v=personnel-modal-invite-fix-77'), 'cache-bust هماهنگی تم و ورود آنلاین کارکنان باید روی نسخه آنلاین هم اعمال شود');
}
