...
mustContain(html, 'styles.css?v=pos-channel-active-restore-7');
mustContain(html, 'core.js?v=pos-channel-active-restore-7');
mustContain(html, 'app.js?v=pos-channel-active-restore-7');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=pos-channel-active-restore-7') && index.includes('core.js?v=pos-channel-active-restore-7') && index.includes('app.js?v=pos-channel-active-restore-7'), 'cache-bust هماهنگی تم باید روی نسخه آنلاین هم اعمال شود');
}
