...
mustContain(html, 'styles.css?v=cashier-order-note-popup-146');
mustContain(html, 'core.js?v=cashier-order-note-popup-146');
mustContain(html, 'app.js?v=cashier-order-note-popup-146');
mustContain(html, 'core.js?v=cashier-order-note-popup-146');
...
mustContain(app, 'cashier-order-note-popup-146', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-order-note-popup-146', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(dashboardSource, 'cashier-order-note-popup-146', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-order-note-popup-146') && index.includes('core.js?v=cashier-order-note-popup-146') && index.includes('app.js?v=cashier-order-note-popup-146'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
