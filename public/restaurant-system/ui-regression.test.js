...
mustContain(html, 'styles.css?v=table-qr-test-104');
mustContain(html, 'core.js?v=table-qr-test-104');
mustContain(html, 'app.js?v=table-qr-test-104');
mustContain(html, 'core.js?v=table-qr-test-104');
...
mustContain(dashboardSource, 'table-qr-test-104', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=table-qr-test-104') && index.includes('core.js?v=table-qr-test-104') && index.includes('app.js?v=table-qr-test-104'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
