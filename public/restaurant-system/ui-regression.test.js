...
mustContain(html, 'styles.css?v=cashier-payment-popup-raised-187');
mustContain(html, 'core.js?v=cashier-payment-popup-raised-187');
mustContain(html, 'app.js?v=cashier-payment-popup-raised-187');
mustContain(html, 'core.js?v=cashier-payment-popup-raised-187');
...
mustContain(app, 'cashier-payment-popup-raised-187', 'لینک‌های QR/رسید باید token جدید باز/بستن صندوق shared را داشته باشند.');
...
mustContain(app, 'cashier-payment-popup-raised-187', 'لینک‌های QR و صندوق باید token جدید نسخه جاری را داشته باشند.');
...
mustContain(styles, '.hall-payment-popup-backdrop{position:fixed!important;inset:0!important;z-index:175!important;display:flex!important;align-items:flex-start!important;justify-content:center!important;padding:clamp(10px,3vh,24px) clamp(14px,3vw,30px)!important', 'backdrop popup پرداخت باید برای بالا آوردن popup آماده باشد.');
mustContain(styles, 'Hall payment popup raised over channel tabs and scroll retention.', 'popup پرداخت باید روی لاین فروش سالن/دلیوری بالا بیاید و scroll داخلی پایدار بماند.');
...
mustContain(styles, '.hall-payment-popup{max-height:calc(100vh - 28px)!important;margin-top:calc(-1 * clamp(92px,13vh,122px))!important}', 'خود popup پرداخت باید با margin منفی کنترل‌شده بالاتر بیاید و روی لاین فروش سالن/دلیوری قرار بگیرد.');
...
mustContain(dashboardSource, 'cashier-payment-popup-raised-187', 'Dashboard iframe cache-bust token must match the VAT open-order fix.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=cashier-payment-popup-raised-187') && index.includes('core.js?v=cashier-payment-popup-raised-187') && index.includes('app.js?v=cashier-payment-popup-raised-187'), 'cache-bust اصلاح اعمال مالیات روی فیش باز باید روی نسخه آنلاین هم اعمال شود');
}
