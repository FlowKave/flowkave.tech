...
mustContain(html, 'styles.css?v=kitchen-queue-removed-81');
mustContain(html, 'core.js?v=kitchen-queue-removed-81');
mustContain(html, 'app.js?v=kitchen-queue-removed-81');
mustContain(html, 'core.js?v=kitchen-queue-removed-81');
...
mustContain(dashboardSource, 'kitchen-queue-removed-81', 'Dashboard iframe cache-bust token must match the online kitchen queue removal.');
...
function testThemeHarmonyForCashierTablesAndPos() {
  ...
  assert(index.includes('styles.css?v=kitchen-queue-removed-81') && index.includes('core.js?v=kitchen-queue-removed-81') && index.includes('app.js?v=kitchen-queue-removed-81'), 'cache-bust حذف صف سفارش آشپزخانه باید روی نسخه آنلاین هم اعمال شود');
}
